...
const EmployeeAttendanceModal = ({ employee, onClose }) => {
  ...
  // way to fill the lat/lng fields (e.g. verifying WFH or on-site presence).
                  ...
                  {selectedRecord.status === "present" && (
                    <>
                      ...
                      {(selectedRecord.workMode === "Work From Office" ||
                        selectedRecord.workMode === "Work From Home") && (
                        <div className="adm-date-row">
                          <span>{selectedRecord.workMode === "Work From Home" ? "Home Location" : "Check-In Location"}</span>
                          <strong>
                        ...
                        <div className="adm-sessions">
                          ...
                          {selectedRecord.sessions.map((s, i) => (
                            <div key={i} className="adm-session-row">
                              ...
                              {(s.workMode === "Work From Office" || s.workMode === "Work From Home") && hasCoords(s.location) && (
                                <a
              ...
              <div className="adm-date-body">
                ...
                {editForm.status === "present" && (
                  <>
                    ...
                    {(editForm.workMode === "Work From Office" ||
                      editForm.workMode === "Work From Home" ||
                      editForm.workMode === "Site Visit") && (
                      <div className="input-group" style={{ marginBottom: 12 }}>
                        <label>
                          {editForm.workMode === "Work From Home"
